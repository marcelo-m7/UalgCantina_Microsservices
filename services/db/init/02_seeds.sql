...
-- 1) Insere usuário de exemplo
INSERT INTO users (name, email, role) VALUES
    ('Marcelo Santos', 'marcelosouzasantos77@gmail.com', 'admin');

-- 2) Insere dados de exemplo em allergens
...
-- 3) Insere dados de exemplo em dishes
...
-- 4) Insere relação entre dishes e allergens
...
-- 5) Insere dados de exemplo em weekly_menus
INSERT INTO weekly_menus (week_id, start_date, end_date) VALUES
    ('week-2023-W40', '2023-10-02', '2023-10-08');

-- 6) Insere dados de exemplo em day_menus
INSERT INTO day_menus (date, weekly_menu_id) VALUES
    ('2023-10-02', 'week-2023-W40'),
    ('2023-10-03', 'week-2023-W40');

-- 7) Insere dados de exemplo em menu_entries
...
-- 8) Vincula os entries de almoço e jantar ao day_menus
UPDATE day_menus
SET
