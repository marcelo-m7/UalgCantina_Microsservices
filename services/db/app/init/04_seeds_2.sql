...
-- Dias da semana 23
INSERT IGNORE INTO menu_entries (id, date, meal_type, main_dish_id, alt_dish_id, dessert_id, sopa_id) VALUES
...
INSERT IGNORE INTO day_menus (date, weekly_menu_id, lunch_entry_id, dinner_entry_id) VALUES
